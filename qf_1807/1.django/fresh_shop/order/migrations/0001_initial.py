# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-12-10 02:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pay_status', models.CharField(choices=[('TRADE_CLOSE', '交易关闭'), ('WAIT_BUYER_PAY', '交易创建'), ('paying', '待支付'), ('TRADE_FINISHED', '交易结束'), ('TRADE_SUCCESS', '成功')], default='paying', max_length=20, verbose_name='交易状态')),
