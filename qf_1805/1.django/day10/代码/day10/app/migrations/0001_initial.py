# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-09-21 01:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('c', models.ManyToManyField(null=True, to='app.Course')),
                ('g', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='stu', to='app.Grade')),
            ],
            options={
